...
// function setupTagModalHandlers() {
//     // let tag_modal = document.getElementById("tag-modal");
//     let tag_modal = document.querySelector("#tag-modal");
//     const open_Button = document.querySelector(".tag-button");
//     const close_Button = document.getElementById("close-tag-modal");
...
function initializeApp() {
    ...
    setupEventListeners();
    // Storing the modalHandler to extract display function from it.
    modalHandlers = setupModalHandlers();
    setupUserModal();
    populateUserList();
    // setupTagModalHandlers();
    pageManager.showPage('home');
}
...
function populateUserList() {
    ...
    userList.forEach((user, index) => {
        ...
        userItem.addEventListener('click', () => {
            ...
            modalHandlers.displayTask(currentUser);
            userModal.classList.remove('active');
        });
