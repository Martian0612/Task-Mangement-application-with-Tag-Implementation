...
export class IndexedDBStorage {
    constructor(dbName = 'TaskforgeDB', version = 1) {
        this.dbName = dbName;
    ...
    async savePreferences(preferences) {
        return new Promise((resolve, reject) => {
            ...
            preferences.id = `${currentUser.username}-preferences`;
    ...
    async getPreferences() {
        return new Promise((resolve, reject) => {
            ...
            const request = store.get(`${currentUser.username}-preferences`);

            request.onsuccess = (event) => {
                const preferences = event.target.result || {
                    id: `${currentUser.username}-preferences`,
